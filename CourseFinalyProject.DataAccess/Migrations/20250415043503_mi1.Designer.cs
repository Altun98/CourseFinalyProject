...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CourseFinalyProject.Entities.Concrete.Give", b =>
                {
                    ...
                    b.Property<int?>("DodtGoAbroadId")
                        .HasColumnType("int");

                    b.Property<int?>("EmployeeDocumentId")
                        .HasColumnType("int");

                    b.Property<int?>("ExtenstionOFServiceLifeId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("DodtGoAbroadId");

                    b.HasIndex("EmployeeDocumentId");

                    b.HasIndex("ExtenstionOFServiceLifeId");
            ...
            modelBuilder.Entity("CourseFinalyProject.Entities.Concrete.Give", b =>
                {
                    b.HasOne("CourseFinalyProject.Entities.Concrete.DodtGoAbroad", null)
                        .WithMany("Gives")
                        .HasForeignKey("DodtGoAbroadId");
                    ...
                    b.HasOne("CourseFinalyProject.Entities.Concrete.ExtenstionOFServiceLife", null)
                        .WithMany("Gives")
                        .HasForeignKey("ExtenstionOFServiceLifeId");
